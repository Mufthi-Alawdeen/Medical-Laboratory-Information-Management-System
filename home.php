...
<HTML>
	...
	<body>
		...
		<div class="pill-nav">
						<!-- ...Existing menu links... -->
						<a href="generalhome.php" class="login-button">Logout</a>
						</div>
		<br><br><br>
		<div class="pill-nav">
		...
		<?php 
		session_start();
		echo  '<b><center><p style="font-size: 30px; font-family: Verdana, sans-serif; color:#095d83"> Hello ,' . $_SESSION["username"]. '!' . '</p><c/center></b>'  ?>
