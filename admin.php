...
<HTML>
	...
	<body>
		...
		<h1 text align="center" style="font-family:verdana ; font-size:27px " >Welcome ADMIN</h1>
		<br><br>
		<br><br>
		<br><br>
		...
		<div class="row">
		  <div class="column">
			<div class="card">
			  ...
			  <p><a href="Sub Pages/appoint.html"><button>Add new reports</button></a></p>
		</div>
		  </div>
		  <div class="column">
			<div class="card">
			  <img src="images/Test.png" alt="Denim Jeans" style="width:100%">
			  <p><a href="Sub Pages/appoint.html"><button>Add new tests</button></a></p>
		</div>
		  </div>
		  <div class="column">
			<div class="card">
			  <img src="images/Inquirey.png" alt="Denim Jeans" style="width:100%">
			  <p><a href="Sub Pages/appoint.html"><button>Veiw Inquiry</button></a></p>
		</div>
		  </div>
		</div>
